      ...
      <main>
        ...
        <section className="py-24 border-t border-glassBorder text-center bg-[#080b12]" id="download">
          <div className="container mx-auto px-8 relative z-10">
            ...
            <p className="text-xl text-textSecondary mb-8 max-w-2xl mx-auto">Join the closed beta and experience truly private AI. No servers, no subscriptions, just fast on-device captioning.</p>
